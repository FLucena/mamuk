...
// Memoize the ExerciseModal component to prevent unnecessary re-renders
export default memo(function ExerciseModal({ isOpen, onClose, exercise }: ExerciseModalProps) {
