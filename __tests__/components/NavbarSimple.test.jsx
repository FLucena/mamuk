...
describe('NavbarSimple', () => {
  ...
  it('renders the navbar with home link', () => {
    ...
    expect(screen.getByText('Inicio', { selector: '.md\\:block button' })).toBeInTheDocument();
  ...
  it('shows admin link when user is admin', () => {
    ...
    expect(screen.getByText('Admin', { selector: '.md\\:block button' })).toBeInTheDocument();
  ...
  it('shows coach link when user is coach', () => {
    ...
    expect(screen.getByText('Coach', { selector: '.md\\:block button' })).toBeInTheDocument();
  ...
  it('calls navigateTo when a link is clicked', () => {
    ...
    fireEvent.click(screen.getByText('Inicio', { selector: '.md\\:block button' }));
